...
/**
 * Created by azphyo on 11/10/2017.
 */
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public Contact getContact(int id){
        ...
        //Cursor cursor = db.query(TABLE_CONTACTS, new String[] {KEY_ID, KEY_NAME, KEY_PH_NO}, KEY_PH_NO}, KEY_ID + "=?", new String[] {String.valueOf(id)}, null, null, null, null);
